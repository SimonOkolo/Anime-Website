      ...
      <div class="col">
        ...
        <div class="form-wrap animate__animated animate__fadeIn">
          ...
          <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate>
            <div class="mb-3">
              <input type="input" class="form__field" placeholder="Email or username" name="user_login" id="user_login" value="<?= $user_login; ?>">
              <label for="user_login" class="form__label">Email or username</label>
              <small class="text-danger"><?= $user_login_err; ?></small>
            </div>
            <div class="mb-2">
              <input type="password" class="form__field" placeholder="Password" name="user_password" id="user_password">
